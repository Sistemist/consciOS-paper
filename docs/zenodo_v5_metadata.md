...
**Version 5:** Major journal-submission revision. Reframed the manuscript for Frontiers in Artificial Intelligence as a Hypothesis and Theory article; sharpened AI-alignment scope; added journal-style data availability, ethics, author contribution, funding, conflict of interest, and generative AI statements; removed nonessential metaphor/branding language from the operational glossary; clarified that the toy simulation is illustrative instrumentation rather than empirical validation; updated Figure 3 terminology and prior-update labeling; refreshed repository metadata, citation metadata, license/contact details, and build outputs. Core architecture, mathematical structure, and proposed research program remain continuous with v4.

## Keywords

consciousness architecture; AI alignment; viable systems model; active inference; hierarchical reinforcement learning; interoception; coherence-based control; human-AI hybrids; cybernetics; systems engineering
